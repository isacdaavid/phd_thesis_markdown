...
\begin{tikzpicture}[->, >=stealth', auto, semithick, node distance=1.25cm]
    ...
    % fixation point
    \node (jitter)[right=1cm of ☺*] {...};  % both's sum = 1800 ms. {{500,1300},{800,1000}}
    \node (start)[left of=☺] {...};
    ...
    \path(😐*) edge node{\footnotesize $.25$} (jitter);
    ...
    \draw[-,decorate,decoration={brace,amplitude=3pt,mirror}] (-.5,-4)
        -- (.5,-4) node[pos=0.5,anchor=north,yshift=-1]{\footnotesize  $1000\;ms$};
    ...
    \draw[-,decorate,decoration={brace,amplitude=3pt,mirror}] (5.3,-4)
       -- (6.4,-4) node[pos=0.5,anchor=north,yshift=-1]{\footnotesize  $1500\;ms$};
