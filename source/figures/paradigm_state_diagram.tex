...
\begin{tikzpicture}[->, >=stealth', auto, semithick, node distance=1.25cm]
    ...
    \draw[-,decorate,decoration={brace,amplitude=3pt,mirror}] (7.8,-4)
        -- (8.8,-4) node[pos=0.5,anchor=north,yshift=-1]{\footnotesize  $1500\;ms$};
    \draw[-,decorate,decoration={brace,amplitude=3pt,mirror}] (9,-4)
       -- (10.2,-4) node[pos=0.5,anchor=north,yshift=-1]{\footnotesize  $500\;ms$};
